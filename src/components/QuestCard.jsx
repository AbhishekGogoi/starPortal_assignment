          ...
          <div className="ml-4">
            ...
            <div className="mt-4 flex items-center">
              <img
                ...
                className="w-6 h-6"
              />
              <span className="ml-2">1490 XPs</span>
            </div>
          </div>
        </div>
        {dropdownOpen && (
          <div className="mt-4 bg-gray-700 rounded-lg p-4 w-full">
            <div className="overflow-y-auto max-h-96">
              <div className="flex items-center justify-between p-4 bg-gray-800 rounded-lg mb-4">
                <img
                  src="/src/assets/cryptoImage1.png"
                  alt="Task 1"
              ...
              <div className="flex items-center justify-between p-4 bg-gray-800 rounded-lg mb-4">
                <img
                  src="/src/assets/cryptoImage2.jpg"
                  alt="Task 2"
                  className="w-28 h-20 rounded-md"
                />
                <div className="ml-6 flex-1">
              ...
              <div className="flex items-center justify-between p-4 bg-gray-800 rounded-lg mb-4">
                <img
                  src="/src/assets/cryptoImage3.jpg"
                  alt="Task 3"
                  className="w-28 h-20 rounded-md"
                />
                <div className="ml-6 flex-1">
              ...
              <div className="flex items-center justify-between p-4 bg-gray-800 rounded-lg mb-4">
                <img
                  src="/src/assets/cryptoImage4.jpg"
                  alt="Task 4"
                  className="w-28 h-20 rounded-md"
                />
                <div className="ml-6 flex-1">
              ...
              <div className="flex items-center justify-between p-4 bg-gray-800 rounded-lg mb-4">
                <img
                  src="/src/assets/cryptoImage5.jpg"
                  alt="Task 5"
                  className="w-28 h-20 rounded-md"
                />
                <div className="ml-6 flex-1">
                  <h3 className="text-lg font-bold">
                    #5: NFT's and why they're...
                  </h3>
                  <p className="text-sm text-gray-400">6 Tasks</p>
                  <div className="bg-gray-600 h-2 rounded-full mt-1">
                    <div className="bg-indigo-600 h-full w-1/4 rounded-full"></div>
                  </div>
                </div>
              ...
              <div className="flex items-center justify-between p-4 bg-gray-800 rounded-lg mb-4">
                <img
                  src="/src/assets/cryptoImage6.jpg"
                  alt="Task 6"
                  className="w-28 h-20 rounded-md"
                />
                <div className="ml-6 flex-1">
